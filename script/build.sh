...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
  ...
  sudo apt install -y make cmake autoconf automake autotools-dev autopoint libtool m4 tcl
  ...
  curl -L https://github.com/KaiserLancelot/klib/releases/download/v0.7.10/klib-v0.7.10-ubuntu-20.04.deb \
    -o klib.deb
  sudo dpkg -i klib.deb

  curl -L https://github.com/KaiserLancelot/kpkg/releases/download/v0.7.4/kpkg-v0.7.4-ubuntu-20.04.deb \
    -o kpkg.deb
  ...
  kpkg install lcov catch2 fmt boost icu pugixml spdlog cli11 indicators
  sudo ldconfig
else
