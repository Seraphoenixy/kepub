  ...
  for (const auto code_point : str) {
    ...
    if (klib::is_whitespace(code_point)) {
      ...
      static const phmap::flat_hash_map<char32_t, char32_t> map2{
          {U'＆', U'&'}, {U'•', U'·'},  {U'─', U'—'},  {U'０', U'0'},
          {U'１', U'1'}, {U'２', U'2'}, {U'３', U'3'}, {U'４', U'4'},
          {U'５', U'5'}, {U'６', U'6'}, {U'７', U'7'}, {U'８', U'8'},
          {U'９', U'9'}, {U'Ａ', U'A'}, {U'Ｂ', U'B'}, {U'Ｃ', U'C'},
          {U'Ｄ', U'D'}, {U'Ｅ', U'E'}, {U'Ｆ', U'F'}, {U'Ｇ', U'G'},
          {U'Ｈ', U'H'}, {U'Ｉ', U'I'}, {U'Ｊ', U'J'}, {U'Ｋ', U'K'},
          {U'Ｌ', U'L'}, {U'Ｍ', U'M'}, {U'Ｎ', U'N'}, {U'Ｏ', U'O'},
          {U'Ｐ', U'P'}, {U'Ｑ', U'Q'}, {U'Ｒ', U'R'}, {U'Ｓ', U'S'},
          {U'Ｔ', U'T'}, {U'Ｕ', U'U'}, {U'Ｖ', U'V'}, {U'Ｗ', U'W'},
          {U'Ｘ', U'X'}, {U'Ｙ', U'Y'}, {U'Ｚ', U'Z'}, {U'ａ', U'a'},
          {U'ｂ', U'b'}, {U'ｃ', U'c'}, {U'ｄ', U'd'}, {U'ｅ', U'e'},
          {U'ｆ', U'f'}, {U'ｇ', U'g'}, {U'ｈ', U'h'}, {U'ｉ', U'i'},
          {U'ｊ', U'j'}, {U'ｋ', U'k'}, {U'ｌ', U'l'}, {U'ｍ', U'm'},
          {U'ｎ', U'n'}, {U'ｏ', U'o'}, {U'ｐ', U'p'}, {U'ｑ', U'q'},
          {U'ｒ', U'r'}, {U'ｓ', U's'}, {U'ｔ', U't'}, {U'ｕ', U'u'},
          {U'ｖ', U'v'}, {U'ｗ', U'w'}, {U'ｘ', U'x'}, {U'ｙ', U'y'},
          {U'ｚ', U'z'}};
