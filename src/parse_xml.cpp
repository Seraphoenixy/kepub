...
//  if (child.empty()) {
//    error(
//        "can not find this node: {} {} {}, curr node name: {} {}, and xml:
//        {}", name, attr_name, attr_value, node_.name(),
//        node_.attribute("class").value(), to_string());
//  }
//
//  node_ = child;
//}
...
//}
//
// std::vector<std::string> XHTML::get_children_text(std::string_view name)
// const {
//  std::vector<std::string> result;
//
//  if (std::empty(name)) {
...
//  } else {
//    push_back("h1", {{"class", "FZCYSK"}}, title);
//  }
//}
//
