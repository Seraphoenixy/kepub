...
//
// void Epub::add_content(const Content& content) {
...
//    Epub::add_file_in_content_opf(content_opf_, file_name, "Text/" +
//    file_name,
...
//      content.push_lines(get_text(urls[i]));
//
//      std::ofstream ofs(root_ / "OEBPS" / "Text" / num_to_chapter_name(i +
//      1)); check_and_write_file(ofs, generate_chapter(content));
//
...
//
//  auto start_id =
//      (toc_ncx.has_child() ? std::stoi(toc_ncx.last_child_attr("playOrder")) +
//      1
//                           : 1);
//
//  Node node("navPoint");
...
//  content_opf_.reset();
//  content_opf_.move_by_name("metadata");
//  content_opf_.push_back("meta", {{"name", "cover"}, {"content",
//  "cover.jpg"}});
//
//  Epub::add_file_in_content_opf(content_opf_, "cover.jpg", "Images/cover.jpg",
//                                "image/jpeg");
//  Epub::add_file_in_content_opf(content_opf_, "cover.xhtml",
//  "Text/cover.xhtml",
//                                "application/xhtml+xml");
//
